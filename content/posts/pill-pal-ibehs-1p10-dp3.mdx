...
## [](https://ahmedz.willow.camp/posts/json#preliminary-idea-generation)Preliminary Idea Generation
...
## [](https://ahmedz.willow.camp/posts/json#input-and-output-devices)Input and Output Devices:

> ### [](https://ahmedz.willow.camp/posts/json#%EF%B8%8F-time-of-flight-vl530x-distance-sensor-input)✈️ [**Time of Flight VL530X Distance Sensor (INPUT):**](https://www.adafruit.com/product/3317?srsltid=AfmBOoq6jcDRjIe1-v2LC700g1j3xpTr15vevfr75LmpryERUqAZtvcS)
> 
...
> ### [](https://ahmedz.willow.camp/posts/json#-sg90-servo-motor-output)🛠 [**SG90 Servo Motor (OUTPUT):**](https://www.adafruit.com/category/232?srsltid=AfmBOooByslVqKvIC_yQsAJa_bhBxYOgKxYDwZX76zXJSIbFSgqRFn5E)
> 
...
> ### [](https://ahmedz.willow.camp/posts/json#-light-emitting-diode-output)💡 **Light Emitting Diode (OUTPUT):**
> 
...
## [](https://ahmedz.willow.camp/posts/json#python-and-prototyping)Python and Prototyping:
...
## [](https://ahmedz.willow.camp/posts/json#graphical-user-interface)Graphical User Interface:
...
> ### [](https://ahmedz.willow.camp/posts/json#-dont-be-afraid-to-try-new-things)💊 Don’t be afraid to try new things!!
> 
...
> ### [](https://ahmedz.willow.camp/posts/json#-communication-is-key)💊 Communication is key:
> 
